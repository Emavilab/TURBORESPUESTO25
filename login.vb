...
Public Class login
    Private Sub accederbtn_Click(sender As Object, e As EventArgs) Handles accederbtn.Click
        ...
        Dim query As String = "SELECT u.id_usuario, u.id_rol, u.nombre_usuario, r.nombre_rol FROM usuarios u INNER JOIN rol r ON u.id_rol = r.id_rol WHERE u.nombre_usuario = @usuario AND u.contraseña = @contraseña"
                ...
                Using command As New MySqlCommand(query, connection)
                    ...
                    Using reader As MySqlDataReader = command.ExecuteReader()
                        If reader.Read() Then
                            ...
                            Dim nombreUsuario As String = reader("nombre_usuario").ToString()
                            ...
                            siguienteFormulario.NombreUsuario = nombreUsuario ' <-- Aquí lo asignas
